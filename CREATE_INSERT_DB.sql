...
CREATE TABLE BERLET_TIPUS (
  tipus VARCHAR2(250) PRIMARY KEY,
  ar INT
);
...
CREATE SEQUENCE BERLET_SEQUENCE START WITH 1 INCREMENT BY 1 NOMAXVALUE; 
...
CREATE SEQUENCE LOG_SEQUENCE START WITH 1 INCREMENT BY 1 NOMAXVALUE;
...
INSERT INTO BERLET VALUES (BERLET_SEQUENCE.nextval, SYSDATE-2, SYSDATE+30, 'Havi');
INSERT INTO BERLET VALUES (BERLET_SEQUENCE.nextval, SYSDATE-3, SYSDATE+73, 'Nyugdijas');
INSERT INTO BERLET VALUES (BERLET_SEQUENCE.nextval, SYSDATE-5, SYSDATE+33, 'Diak');
INSERT INTO BERLET VALUES (BERLET_SEQUENCE.nextval, SYSDATE, SYSDATE+55, 'Iskolai');
INSERT INTO BERLET VALUES (BERLET_SEQUENCE.nextval, SYSDATE, SYSDATE+22, 'Felnott');
INSERT INTO BERLET VALUES (BERLET_SEQUENCE.nextval, SYSDATE-10, SYSDATE+22, 'Gyermek');
INSERT INTO BERLET VALUES (BERLET_SEQUENCE.nextval, SYSDATE, SYSDATE+11, 'Csoportos');
INSERT INTO BERLET VALUES (BERLET_SEQUENCE.nextval, SYSDATE - 110, SYSDATE, 'Havi');
INSERT INTO BERLET VALUES (BERLET_SEQUENCE.nextval, SYSDATE - 15, SYSDATE + 15, 'Hetiberlet');
INSERT INTO BERLET VALUES (BERLET_SEQUENCE.nextval, SYSDATE - 3, SYSDATE + 27, 'Nyugdijas');
INSERT INTO BERLET VALUES (BERLET_SEQUENCE.nextval, SYSDATE - 7, SYSDATE + 23, 'Diak');
INSERT INTO BERLET VALUES (BERLET_SEQUENCE.nextval, SYSDATE - 44, SYSDATE + 28, 'Iskolai');
INSERT INTO BERLET VALUES (BERLET_SEQUENCE.nextval, SYSDATE - 20, SYSDATE + 10, 'Felnott');
INSERT INTO BERLET VALUES (BERLET_SEQUENCE.nextval, SYSDATE - 25, SYSDATE + 5, 'Gyermek');
INSERT INTO BERLET VALUES (BERLET_SEQUENCE.nextval, SYSDATE - 11, SYSDATE + 19, 'Csoportos');
...
INSERT INTO UTAS VALUES (UTAS_SEQUENCE.nextval, 'Toth Anna', '06301234567', 'Szeged, Fo ter 1.', SYSDATE-9000, 'no', 1);
INSERT INTO UTAS VALUES (UTAS_SEQUENCE.nextval, 'Nagy Bela', '06307654321', 'Budapest, Kossuth ter 2.', SYSDATE-11000, 'ferfi', 2);
INSERT INTO UTAS VALUES (UTAS_SEQUENCE.nextval, 'Kiss Csaba', '06303456789', 'Debrecen, Petofi ter 3.', SYSDATE-10000, 'ferfi', 4);
INSERT INTO UTAS VALUES (UTAS_SEQUENCE.nextval, 'Varga Dora', '06304567891', 'Pecs, Szabadsag ter 4.', SYSDATE-12000, 'no', 5);
INSERT INTO UTAS VALUES (UTAS_SEQUENCE.nextval, 'Horvath Emese', '06305678912', 'Gyor, Arany Janos u. 5.', SYSDATE-13000, 'no', 6);
INSERT INTO UTAS VALUES (UTAS_SEQUENCE.nextval, 'Szabo Fanni', '06306789123', 'Kecskemet, Batthyany u. 6.', SYSDATE-14000, 'no', 3);
INSERT INTO UTAS VALUES (UTAS_SEQUENCE.nextval, 'Kis Gergo', '06307891234', 'Nyiregyhaza, Kossuth Lajos u. 7.', SYSDATE-8500, 'ferfi', 7);
INSERT INTO UTAS VALUES (UTAS_SEQUENCE.nextval, 'Farkas Hilda', '06308912345', 'Zalaegerszeg, Dozsa Gy. u. 8.', SYSDATE-7500, 'no', 9);
INSERT INTO UTAS VALUES (UTAS_SEQUENCE.nextval, 'Balogh Istvan', '06301231234', 'Veszprem, Wartha V. u. 9.', SYSDATE-6500, 'ferfi', 8);
INSERT INTO UTAS VALUES (UTAS_SEQUENCE.nextval, 'Nemeth Jozsef', '06302342345', 'Szombathely, Rakoczi F. u. 10.', SYSDATE-5500, 'ferfi', 10);
INSERT INTO UTAS VALUES (UTAS_SEQUENCE.nextval, 'Boros Marton', '06303452123', 'Salgotarjan, Szabadsag ter 11.', SYSDATE-4600, 'ferfi', 12);
INSERT INTO UTAS VALUES (UTAS_SEQUENCE.nextval, 'Kovacs Norbert', '06304563234', 'Szekszard, Garay u. 12.', SYSDATE-4700, 'ferfi', 11);
INSERT INTO UTAS VALUES (UTAS_SEQUENCE.nextval, 'Takacs Beatrix', '06305674345', 'Szekesfehervar, Kiraly u. 13.', SYSDATE-4800, 'no', 14);
INSERT INTO UTAS VALUES (UTAS_SEQUENCE.nextval, 'Molnar Cecilia', '06306785456', 'Siofok, Vitorlas u. 14.', SYSDATE-4900, 'no', 13);
INSERT INTO UTAS VALUES (UTAS_SEQUENCE.nextval, 'Papp Dominik', '06307896567', 'Tatabanya, Szent Borbala ter 15.', SYSDATE-5000, 'ferfi', 15);
